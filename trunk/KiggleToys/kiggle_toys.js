...
var a = $('<img />').attr('src', 'images/logo_phrase_on.jpg');
var b = $('<img />').attr('src', 'images/about_kiggle_on.jpg');
var c = $('<img />').attr('src', 'images/products_on.jpg');
var d = $('<img />').attr('src', 'images/contact_us_on.jpg');
var b = $('<img />').attr('src', 'images/tv_teether_remote.jpg');
var c = $('<img />').attr('src', 'images/my_1st_mouse_pad.jpg');
var d = $('<img />').attr('src', 'images/my_1st_smart_phone.jpg');
set_mouse_over('logo', 'images/logo_phrase.jpg', 'images/logo_phrase_on.jpg', 'logo_phrase');
