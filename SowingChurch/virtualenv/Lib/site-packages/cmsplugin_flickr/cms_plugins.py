...
FLICKR_IMAGE_B_URL = "http://farm%(farm)s.static.flickr.com/%(server)s/%(id)s_%(secret)s_b.jpg"
FLICKR_IMAGE_C_URL = "http://farm%(farm)s.static.flickr.com/%(server)s/%(id)s_%(secret)s_c.jpg"
    ...
    def render(self, context, instance, placeholder):
        ...
        if not items:
            ...
            try:
                ...
                if instance.set_id:
                    kwargs.update({'photoset_id': instance.set_id})
                    #photos = f.walk_set(instance.set_id)
                    photos = f.photosets_getPhotos(**kwargs)[0]
                else:
                ...
                for p in photos:
                    ...
                    items.append({'title': p.attrib['title'],
                                  ...
                                  'b_url': FLICKR_IMAGE_B_URL % p.attrib,
                                  'c_url': FLICKR_IMAGE_C_URL % p.attrib,
