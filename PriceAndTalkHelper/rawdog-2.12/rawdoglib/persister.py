...
except ImportError: # windows, probably has only 1 user anyway ;)
	def lockf(file,mode):
		pass
	LOCK_EX=42 # just to have some value there
	LOCK_NB=43 # just to have some value there
import os, errno
import pickle
